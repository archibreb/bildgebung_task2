...
# Load landmarks
# ===============================
fixed_points_list  = load_landmarks_csv(f"{BASE}/landmarksTr/LungCT_0001_0000.csv")
moving_points_list = load_landmarks_csv(f"{BASE}/landmarksTr/LungCT_0001_0001.csv")
...
# Save transform
# ===============================
sitk.WriteTransform(outTx, os.path.join(OUT, "bspline_affine_landmarks_masks.tfm"))
...
sitk.WriteImage(warped_moving, os.path.join(OUT, "registered.nii.gz"))
...
sitk.WriteImage(overlay, os.path.join(OUT, "overlay_rgb.nii.gz"))
